...
d = {"id": 1329, "name": "한승화", "age": 17}
print(d)        # {'id': 1329, 'name': '한승화', 'age': 17}

# 키로 값 가져오기
print(d["name"])        # 한승화(name의 value값)
# print(d["phone"])       # KeyError: 'phone'
...
d["age"] += 1
print(d)        # {'id': 1329, 'name': '한승화', 'age': 18}

d["phone"] = "123-4567"
print(d)        # {'id': 1329, 'name': '한승화', 'age': 18, 'phone': '123-4567'}

del d["phone"]  # phone 삭제
print(d)        # {'id': 1329, 'name': '한승화', 'age': 18}

print(d.pop("age"))     # 18
print(d)        # {'id': 1329, 'name': '한승화'}
...
# 딕셔너리 순회
for key in d:
    print(key,d[key])       # id 1329/name 한승화

for i, data in enumerate(d):
    print(i, data)      # 0 id/1 name

for value in d.values():
    print(value)        # 1329/한승화

for key, value in d.items():
    print(key, value)       # id 1329/name 한승화
...
d[0] = "python"
print(d)        # {'id': 1329, 'name': '한승화', 0: 'python'}
...
d["kor"] = 100
print(d)        # {'kor': 100, 'mat': 85, 'eng': 80}

d["sci"] = 80
print(d)        # {'kor': 100, 'mat': 85, 'eng': 80, 'sci': 80}

d[(1, 2)] = 100
print(d)        # {'kor': 100, 'mat': 85, 'eng': 80, 'sci': 80, (1, 2): 100}
